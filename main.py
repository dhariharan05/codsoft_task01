#SIMPLE AI CHATBOT USING RULEBASED RESPONSES
def simple_ai_chatbot(user_input, category):
    # Convert user input to lowercase
    user_input = user_input.lower()

    if category == 1:  # Healthcare-related queries
        ...
        # Common prefix for all responses
...
if category_choice not in ['1', '2']:
    ...
    while active:
        ...
        # Check if the response includes a return message to the main menu
